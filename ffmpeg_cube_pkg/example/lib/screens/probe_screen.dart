            ...
            if (_probeResult != null) ...[
              ...
              if (_probeResult!.videoStream != null) ...[
                ...
                _InfoSection(
                  ...
                  items: [
                    ...
                    _InfoItem(
                        '幀率',
                        _probeResult!.videoStream!.frameRate != null
                            ? '${_probeResult!.videoStream!.frameRate!.toStringAsFixed(2)} fps'
                            : 'N/A'),
                    _InfoItem('像素格式',
                        _probeResult!.videoStream!.pixelFormat ?? 'N/A'),
                  ],
                ),
              ],
              ...
              if (_probeResult!.audioStream != null) ...[
                ...
                _InfoSection(
                  ...
                  items: [
                    ...
                    _InfoItem(
                        '取樣率',
                        _probeResult!.audioStream!.sampleRate != null
                            ? '${_probeResult!.audioStream!.sampleRate} Hz'
                            : 'N/A'),
                    _InfoItem(
                        '聲道數',
                        _probeResult!.audioStream!.channels?.toString() ??
                            'N/A'),
                    _InfoItem('位元率',
                        _formatBitrate(_probeResult!.audioStream!.bitrate)),
                  ],
                ),
              ],
              ...
              if (_probeResult!.subtitleStreams.isNotEmpty) ...[
                ...
                _InfoSection(
                  ...
                  items: _probeResult!.subtitleStreams
                      .map((s) =>
