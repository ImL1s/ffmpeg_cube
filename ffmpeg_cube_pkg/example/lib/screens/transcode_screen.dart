                      ...
                      children: [
                        ...
                        Expanded(
                          child: DropdownButton<VideoCodec>(
                            ...
                            items: const [
                              DropdownMenuItem(
                                  value: VideoCodec.h264, child: Text('H.264')),
                              DropdownMenuItem(
                                  value: VideoCodec.h265,
                                  child: Text('H.265/HEVC')),
                              DropdownMenuItem(
                                  value: VideoCodec.vp9, child: Text('VP9')),
                            ],
                          ),
                        ),
                      ],
                      ...
                      children: [
                        ...
                        Expanded(
                          child: DropdownButton<VideoResolution>(
                            ...
                            items: const [
                              DropdownMenuItem(
                                  value: VideoResolution.r360p,
                                  child: Text('360p')),
                              DropdownMenuItem(
                                  value: VideoResolution.r480p,
                                  child: Text('480p')),
                              DropdownMenuItem(
                                  value: VideoResolution.r720p,
                                  child: Text('720p')),
                              DropdownMenuItem(
                                  value: VideoResolution.r1080p,
                                  child: Text('1080p')),
                            ],
                          ),
                        ),
