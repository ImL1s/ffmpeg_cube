...
import 'wasm_backend_stub.dart'
    if (dart.library.html) 'wasm_backend_web.dart' as impl;
  ...
  Future<JobResult<void>> execute(
    ...
    try {
      await impl.executeWasm(
        args,
        onProgress: onProgress != null ? (double progress) {
