  ...
  factory ProbeResult.fromJson(String filePath, Map<String, dynamic> json) {
    ...
    for (final stream in streams) {
      ...
      if (codecType == 'video' && videoStream == null) {
        ...
        subtitleStreams.add(SubtitleStreamInfo.fromJson(stream as Map<String, dynamic>));
      }
    }
    ...
    return ProbeResult(
      ...
      duration: format?['duration'] != null 
          ? Duration(milliseconds: (double.parse(format!['duration'].toString()) * 1000).round())
          : null,
      format: format?['format_name'] as String?,
      fileSize: format?['size'] != null ? int.tryParse(format!['size'].toString()) : null,
      bitrate: format?['bit_rate'] != null ? int.tryParse(format!['bit_rate'].toString()) : null,
...
class VideoStreamInfo {
  ...
  factory VideoStreamInfo.fromJson(Map<String, dynamic> json) {
    ...
    return VideoStreamInfo(
      ...
      frameRate: fps,
      bitrate: json['bit_rate'] != null ? int.tryParse(json['bit_rate'].toString()) : null,
